    var XBBCODE = (function() {
        ...
        tags = {
            ...
            */
            ...
            "mask":{
                openTag: function(params,content) {
                    return '<span style="background-color:#555;color:#555;border:1px solid #555;">';
                },
                closeTag: function(params,content) {
                    return '</span>';
                }
            ...
            "large": {
                openTag: function(params,content) {
                    ...
                    return '<span class="bbcode-size-36" style="color:' + colorCode + '">';
                },
                closeTag: function(params,content) {
                    return '</span>';
                }
            ...
            "size": {
                openTag: function(params,content) {
                    ...
                    return '<span class="bbcode-size-' + mySize + '">';
                },
                closeTag: function(params,content) {
                    return '</span>';
                }
            ...
            "small": {
                openTag: function(params,content) {
                    ...
                    return '<span class="bbcode-size-10" style="color:' + colorCode + '">';
                },
                closeTag: function(params,content) {
                    return '</span>';
                }
